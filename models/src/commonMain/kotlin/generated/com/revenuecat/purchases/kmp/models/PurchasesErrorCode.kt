...
@file:Suppress("MagicNumber", "MaximumLineLength", "MaxLineLength", "ArgumentListWrapping", "TrailingCommaOnCallSite", "InvalidPackageDeclaration")
...
public enum class PurchasesErrorCode(public val code: Int, public val description: String) {
    ...
    ProductDiscountMissingIdentifierError(26, "The SKProductDiscount or Product.SubscriptionOffer wrapped by StoreProductDiscount is missing an identifier. This is a required property and likely an AppStore quirk that it is missing."),
    CustomerInfoError(28, "There was a problem related to the customer info."),
    ProductDiscountMissingSubscriptionGroupIdentifierError(29, "Unable to create a discount offer, the product is missing a subscriptionGroupIdentifier."),
    ...
    ApiEndpointBlocked(33, "Requests to RevenueCat are being blocked. See: https://rev.cat/dnsBlocking for more info."),
    InvalidPromotionalOfferError(34, "The information associated with this PromotionalOffer is not valid. See https://rev.cat/ios-subscription-offers for more info."),
    OfflineConnectionError(35, "Error performing request because the internet connection appears to be offline."),
    ...
    FeatureNotAvailableInCustomEntitlementsComputationMode(37, "This feature is not available when utilizing the customEntitlementsComputation dangerousSetting."),
    FeatureNotSupportedWithStoreKit1(38, "This feature is not supported when using StoreKit 1. Configure the SDK to use StoreKit 2 to use this feature."),
    InvalidWebPurchaseToken(39, "The link you provided does not contain a valid purchase token."),
    PurchaseBelongsToOtherUser(40, "The web purchase already belongs to another user."),
    ExpiredWebPurchaseToken(41, "The link you provided has expired. A new one will be sent to the email used to make the purchase."),
