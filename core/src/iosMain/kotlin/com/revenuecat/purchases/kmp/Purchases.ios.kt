...
public actual class Purchases private constructor(private val iosPurchases: IosPurchases) {
    ...
    public actual fun purchase(
            ...
            iosPurchases.purchaseProduct(storeProduct) {
                    transaction,
                    customerInfo,
                    error,
                    userCancelled ->
    ...
    public actual fun purchase(
            ...
            iosPurchases.purchasePackage(packageToPurchase) {
                    transaction,
                    customerInfo,
                    error,
                    userCancelled ->
    ...
    public actual fun purchase(
            ...
            iosPurchases.purchaseProduct(storeProduct, promotionalOffer) {
                    transaction,
                    customerInfo,
                    error,
                    userCancelled ->
    ...
    public actual fun purchase(
            ...
            iosPurchases.purchasePackage(packageToPurchase, promotionalOffer) {
                    transaction,
                    customerInfo,
                    error,
                    userCancelled ->
    ...
    public actual fun getCustomerInfo(
            ...
            iosPurchases.getCustomerInfoWithFetchPolicy(fetchPolicy.toRCCacheFetchPolicy()) {
                    customerInfo,
                    error ->
                if (error != null) onError(error.toPurchasesErrorOrThrow())
                else onSuccess(customerInfo ?: error("Expected a non-null RCCustomerInfo"))
