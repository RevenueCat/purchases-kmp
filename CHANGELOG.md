...
* [RENOVATE] Update dependency upstream/purchases-ios to v5.72.0 (#850) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Update Codelabs links (#853) via Jaewoong Eum (@skydoves)
* Bump fastlane from 2.233.1 to 2.234.0 (#852) via dependabot[bot] (@dependabot[bot])
* Remove stale PHC build metadata note from RELEASING.md (#847) via Antonio Pallares (@ajpallares)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.54.0 (#777) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency upstream/purchases-ios to v5.67.0 (#772) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Deletes unused `AdEventTypesMappingsTest` (#776) via JayShortway (@JayShortway)
* Bump fastlane-plugin-revenuecat_internal from `9a6911b` to `f11fe40` (#773) via dependabot[bot] (@dependabot[bot])
* Bump ffi from 1.17.3 to 1.17.4 (#774) via dependabot[bot] (@dependabot[bot])
* security: pin GitHub Actions to SHA hashes (#766) via Alfonso Embid-Desmet (@alfondotnet)
* Pass version to merge-release-pr orb job (#765) via Antonio Pallares (@ajpallares)
...
## RevenueCat SDK
### ✨ New Features
* Add presentCodeRedemptionSheet() support (#729) via Rick (@rickvdl)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.46.0 (#732) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.45.0 (#730) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)
* [RENOVATE] Update dependency upstream/purchases-ios to v5.61.0 (#728) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.44.0 (#726) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.43.0 (#725) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)
...
## RevenueCatUI SDK
### ✨ New Features
* Add PurchaseLogic support to PaywallView (#715) via Rick (@rickvdl)

### 🔄 Other Changes
* [EXTERNAL] fix: handle gradle deprecation warnings for kotlinOptions (#707) contributed by @TheRogue76 (#713) via Toni Rico (@tonidero)
* Bump fastlane-plugin-revenuecat_internal from `f5c099b` to `e146447` (#731) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `8cd957f` to `f5c099b` (#724) via dependabot[bot] (@dependabot[bot])

## 2.7.1+17.42.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.42.0 (#719) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency upstream/purchases-ios to v5.60.0 (#711) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Update sdks-common-config orb to 3.13.0 (#718) via Cesar de la Vega (@vegaro)
* Bump ffi from 1.17.2 to 1.17.3 (#619) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.232.1 to 2.232.2 (#712) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `ea6276c` to `8cd957f` (#706) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.26.0 (#618) via RevenueCat Git Bot (@RCGitBot)
  * [iOS 5.52.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.52.0)
* [RENOVATE] Update dependency upstream/purchases-ios to v5.52.0 (#616) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.21.2 (#595) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency upstream/purchases-ios to v5.49.2 (#594) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.21.1 (#593) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.15.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.15.1)
  * [iOS 5.49.2](https://github.com/RevenueCat/purchases-ios/releases/tag/5.49.2)
  * [iOS 5.49.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.49.1)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.21.0 (#591) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.20.0 (#589) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.15.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.15.0)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [iOS 5.49.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.49.0)

### 🔄 Other Changes
* Bump fastlane from 2.229.0 to 2.229.1 (#590) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.228.0 to 2.229.0 (#587) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `083ced9` to `efca663` (#588) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* Updates purchases-hybrid-common to 17.19.1 (#585) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.18.1 (#579) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [Android 9.14.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.0)
  * [iOS 5.48.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.48.0)
  * [iOS 5.47.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.47.1)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.18.0 (#577) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [Android 9.14.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.0)
  * [iOS 5.48.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.48.0)
  * [iOS 5.47.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.47.1)
* [RENOVATE] Update build-dependencies to v8.13.1 (#575) via RevenueCat Git Bot (@RCGitBot)
* [RENOVATE] Update dependency upstream/purchases-ios to v5.48.0 (#576) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `1e3e3fd` to `083ced9` (#578) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `525d48c` to `1e3e3fd` (#572) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.17.0 (#569) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency upstream/purchases-ios to v5.47.0 (#565) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.16.1 (#566) via RevenueCat Git Bot (@RCGitBot)
